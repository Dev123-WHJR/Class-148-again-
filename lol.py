...
random_number_sorting_list = Label(root)

def randomlist():
    randomlist = random.sample(range(10,30),5)
    random_number_list["text"] = "Random list: " + str(randomlist)
    randomlist.sort()
    random_number_sorting_list["text"] = "Sorted random list: " + str(randomlist)
...
random_number_sorting_list.place(relx=0.5,rely=0.6,anchor=CENTER)
